...
AUTH_USER_MODEL = 'music_app.CustomUser'

#Set AUTHENTICATION_BACKENDS variable to allow the user to login via the user's email
AUTHENTICATION_BACKENDS = ['music_app.common.backends.EmailBackend']
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'music_app.common.validators.ContainsNumberValidator', # Path to your custom validator
        'OPTIONS': {
            'min_number': 1 # Require at least 1 numeric character
        }
    },
    {
        'NAME': 'music_app.common.validators.SpecialCharacterValidator', # Path to your custom validator
        'OPTIONS': {
